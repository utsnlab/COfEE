    ...
    case 'get_entity':
        ...
        while($row = $d->fetch($q)){
            ...
            if($hasEvent == "B_"){
                ...
                $inline_text = $d->getrowvalue("text",'select GROUP_CONCAT(DISTINCT project_phrases_words.word SEPARATOR " ") as text from project_phrases_words where id in ('.$inline_id.') order by id asc', true); 
